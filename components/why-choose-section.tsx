...
export function WhyChooseSection() {
  return (
    <section id="about" className="py-20 px-4 md:px-8 lg:px-12 bg-background border-b border-border/50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="grid grid-cols-2 gap-5">
              {features.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="relative bg-card rounded-xl border border-border border-l-[3.5px] border-l-primary p-5 transition-all duration-300 hover:bg-primary/5 hover:border-cyan hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(30,79,194,0.04)] group overflow-hidden"
                  >
          ...
          {/* Right Panel */}
          <div className="bg-gradient-to-br from-[#0c1830] to-[#060c1a] dark:from-blue-navy dark:to-blue-deep rounded-2xl p-10 border border-border/80 relative overflow-hidden shadow-[0_24px_80px_rgba(10,22,40,0.08)] dark:shadow-[0_24px_80px_rgba(10,22,40,0.25)]">
            {/* Blueprint grid */}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(0,200,255,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(0,200,255,0.035)_1px,transparent_1px)] bg-[size:30px_30px]" />

            {/* Top right glow */}
            <div className="absolute top-[-60px] right-[-60px] w-[200px] h-[200px] bg-[radial-gradient(circle,rgba(0,200,255,0.08)_0%,transparent_70%)] pointer-events-none" />
